...
The network interface with the biggest number, such as lan5, will be made LAN. If there are no interfaces with a number at the end, the first found network interface will be used instead. Other interfaces will be made WAN.
